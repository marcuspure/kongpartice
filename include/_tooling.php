      ...
      <div class="container">
        <div class="row py-4">
          <div class="col-lg-12 text-center font-l fon-weight-l l-h-30">
            ...
            <p class="machine_text">Besides, We increase our capital expenditure year by year to replace and purchase all kinds of new machines. We also keep training our staff’s production skill with a perfectionist attitude.</p>
            <p class="machine_text">We implement strict quality control in production process. In order to monitor every workpiece at production, we implement a tracing system with production barcode. At pre-shipment quality inspection, we will cross-compare the products with the original design and run a full scale test. </p>
            <p class="machine_text">Our task is to shorten delivery date as much as possible without compromising the quality. </p>
            <p class="machine_text">Mission impossible? KONFU challenges the impossible. </p>
          </div>
        </div>
      </div>
    </div>
